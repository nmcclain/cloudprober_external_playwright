...
all:
	...
	cd builds && tar -zcf cloudprober_external_playwright-0.0.1-linux-amd64.tgz  cloudprober_external_playwright-linux-amd64
	cd builds && tar -zcf cloudprober_external_playwright-0.0.1-linux-arm64.tgz  cloudprober_external_playwright-linux-arm64
